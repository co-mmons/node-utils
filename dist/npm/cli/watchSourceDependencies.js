...
var pckg = fs_extra_1.readJsonSync("package.json");
        ...
        if (dependencies[depName].repoPath) {
            ...
            watcher.on("change", function (filename, stats) {
                ...
                for (var _i = 0, _a = [moduleOut_1, out_1]; _i < _a.length; _i++) {
                    var o = _a[_i];
                    fs_extra_1.copySync(filename, path.join(o, filename.substr(source_1.length)), { preserveTimestamps: true });
                }
            });
            ...
            watcher.on("unlink", function (filename, stats) {
                ...
                for (var _i = 0, _a = [moduleOut_1, out_1]; _i < _a.length; _i++) {
                    var o = _a[_i];
                    fs_extra_1.removeSync(path.join(o, filename.substr(source_1.length)));
                }
            });
